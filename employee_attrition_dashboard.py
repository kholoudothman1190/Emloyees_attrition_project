...
with tabs[5]:
    ...
    with col1:
        ...
        hires_by_year = (filtered_df["hiring_year"]
        .value_counts()
        .rename_axis("Year")
        .reset_index(name="Count")
        .sort_values("Year"))
        st.plotly_chart(px.bar(hires_by_year, x="Year", y="Count",color_discrete_sequence=[color_palette[2]]), use_container_width=True)
